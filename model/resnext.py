...
def _resnext(model_path, block, layers, pretrained, **kwargs):
...
def resnext50_32x4d_swsl(pretrain, progress=True, **kwargs):
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _resnext(model_path, Bottleneck, [3, 4, 6, 3], True, **kwargs)


def resnext101_32x4d_swsl(pretrain, progress=True, **kwargs):
    ...
    kwargs['width_per_group'] = 4
    model_path = pretrain
    return _resnext(model_path, Bottleneck, [3, 4, 23, 3], True, progress, **kwargs)

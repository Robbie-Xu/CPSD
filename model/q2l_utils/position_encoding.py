...
def build_position_encoding(args):
    ...
    downsample_ratio = 32
    assert args.image_size % 32 == 0, "args.image_size ({}) % 32 != 0".format(args.image_size)
    position_embedding = PositionEmbeddingSine(N_steps, normalize=True, maxH=args.image_size // downsample_ratio, maxW=args.image_size // downsample_ratio)

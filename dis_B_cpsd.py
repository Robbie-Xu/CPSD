...
parser.add_argument('--partition', type=str, default='0', help='number to distinguish different independent partition experiments')
parser.add_argument('--dataset', type=str, default='coco', help='coco or nuswide')
parser.add_argument('--model-root', default="./models", type=str, help='path to the teacher models, including CGP and DGP models')
